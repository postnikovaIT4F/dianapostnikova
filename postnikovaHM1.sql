...
-- Комментарий:
-- Почему-то сразу не заметил. Но вообще говоря, запрос в задании 4 неверный, поскольку вернет для компаний с отозванными рейтингами, значения рейтингов ДО снятия. У Вас есть возможность поправить задание без потери баллов.
